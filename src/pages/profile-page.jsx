...
const ProfilePage = ({ setCurrentPage, setIsLoggedIn }) => {
  ...
  const handleSaveNotifications = async () => {
    ...
    try {
      ...
      setNotifications({
        pushNotifications:
          data.pushNotifications ?? notifications.pushNotifications,
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      if (!response.ok)
        throw new Error(
          data.errorMessage || data.message || "Failed to load orders.",
        );
      setOrders(data);
  ...
  const handleOrderClick = async (orderId) => {
    ...
    try {
      ...
      if (!response.ok)
        throw new Error(
          data.errorMessage || data.message || "Failed to load order details.",
        );
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.errorMessage || data.message || "Failed to change password.",
        );
      }
        ...
        <div className="profile-card">
          ...
          <div className="avatar-row">
            ...
            >
              ...
              <span className="edit-badge">
                <svg width="11" height="11" fill="white" viewBox="0 0 24 24">
                  <path d="M3 17.25V21h3.75l11.06-11.06-3.75-3.75L3 17.25zm17.71-10.21a1 1 0 000-1.41l-2.34-2.34a1 1 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" />
                </svg>
              </span>
            </div>
            <div className="avatar-info">
              ...
              {profile.memberSince && (
                <div className="user-meta">
                  <CalIcon /> Member since {profile.memberSince}
                </div>
              )}
            </div>
            {profile.isVerified && (
              <span className="verified-badge">
                <VerifyIcon /> Verified User
              </span>
            )}
          </div>
            ...
            <div>
              <div className="tab-section">
                <div className="tab-section-header">
                  <span className="tab-section-icon">
                    <GearIcon color="#4a90d9" />
                  </span>
                  <div>
                ...
                {notificationsLoading ? (
                  ...
                  <>
                    <div className="toggle-row">
                      ...
                      <div
                        className={`toggle-switch${notifications.pushNotifications ? " on" : ""}`}
                        onClick={() =>
                          setNotifications({
                            ...notifications,
                    ...
                    <div className="toggle-row">
                      <div>
                        ...
                        <div className="toggle-sub">
                          Get weekly PC recommendation updates
                        </div>
                      </div>
                      <div
                        className={`toggle-switch${notifications.emailUpdates ? " on" : ""}`}
                        onClick={() =>
                          setNotifications({
                            ...notifications,
                    ...
                    <div className="toggle-row">
                      <div>
                        <div className="toggle-label">Price Drop Alerts</div>
                        <div className="toggle-sub">
                          Get notified when prices drop on saved items
                        </div>
                      </div>
                      <div
                        className={`toggle-switch${notifications.priceDropAlerts ? " on" : ""}`}
                        onClick={() =>
                          setNotifications({
                            ...notifications,
              ...
              <div className="tab-section">
                ...
                {[
                  ...
                  <div key={item.key} className="form-group mb-3">
                    ...
                    <div className="password-wrapper">
                      ...
                      <input
                        className="form-control form-input password-input"
                        type={security[item.showKey] ? "text" : "password"}
                      ...
                      <button
                        type="button"
                        className={`password-toggle-btn ${security[item.showKey] ? "open" : "closed"}`}
                        onClick={() =>
                          setSecurity({
                            ...security,
                            [item.showKey]: !security[item.showKey],
                          })
                        }
                      >
                        <img
                ...
                <div className="requirements-box">
                  <div className="requirements-title">
                    <InfoIcon /> Password Requirements:
                  </div>
                  {[
                    ...
                    <div key={r} className="requirements-item">
                      • {r}
                    </div>
                  ))}
                </div>
          ...
          {activeTab === "orders" && (
            <div>
              <div className="saved-section-header">
                <span className="saved-section-icon">
                  <OrdersIcon color="#4a90d9" />
                </span>
                <div>
                  <div className="saved-section-title">My Orders</div>
                  <div className="saved-section-sub">
                  ...
                  {orders.map((order) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          !isNavigating && handleOrderClick(order.id)
                        }
                      >
                          ...
                          {order.items?.slice(0, 2).map((item, idx) => (
                            <div key={idx} className="order-item-preview">
                              <img
                                ...
                                alt=""
                                className="order-item-preview-img"
                              />
                              ...
                              <span className="order-item-preview-qty">
                                ×{item.quantity}
                              </span>
                            </div>
                          ))}
                        ...
                        <div className="order-card-bottom">
                          <div className="order-meta-pills">
                            <span className="order-meta-pill">
                              <TruckIcon color="#9ca3af" />{" "}
                              {order.deliveryMethod}
                            </span>
                            <span className="order-meta-pill">
                              <CreditCardIcon color="#9ca3af" />{" "}
                        ...
                        <div className="order-card-action">
                          {isNavigating ? (
                            ...
                            <span className="order-view-details-text">
                              View Details →
                            </span>
                          )}
                        </div>
            ...
            <div>
              <div className="saved-section-header">
                ...
                <div>
                  ...
                  <div className="saved-section-sub">
                    View & manage your saved PC recommendations & comparisons
                  </div>
                </div>
              </div>
              {favoritesLoading ? (
          ...
          >
            ...
            <div className="details-modal-grid">
              <div className="details-modal-left">
                <h6 className="details-modal-list-title">
                  Saved Recommendations
                </h6>
                <div className="details-modal-list">
                  {favorites.map((item) => (
                    <div
                      key={item.productId}
                      onClick={() => setSelectedItem(item)}
                      className={`details-modal-item${selectedItem.productId === item.productId ? " active" : ""}`}
                    >
                      <div
                        style={{
                          width: 34,
              ...
              <div className="details-modal-right">
                <div className="details-modal-img">
                  <img
                    src={
                      ...
                      "https://via.placeholder.com/300x180?text=PC"
                    }
                    alt={selectedItem.title}
                  />
                </div>
                <h5 className="details-modal-product-title">
                  {selectedItem.title}
                </h5>
                <div
                  style={{
                ...
                >
                  <span
                    style={{ fontSize: 22, fontWeight: 700, color: "#155DFC" }}
                  >
                ...
                <div className="details-modal-section">
                  ...
                  <div className="details-modal-specs">
                    {selectedItem.keySpecs &&
                      Object.entries(selectedItem.keySpecs).map(
                        ([key, value], i) => (
                          <div
                            key={key}
                            className="details-modal-spec-row"
                            style={{
                              background: i % 2 === 0 ? "#fff" : "#f0f7ff",
                            }}
                          >
                            <span className="details-modal-spec-key">
                              {key}
                            </span>
                            <span className="details-modal-spec-val">
                              {value}
                            </span>
                          </div>
                        ),
                  ...
                  <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                    {["Gaming", "Productivity", "Rendering"].map((label) => (
                      <div key={label} className="details-modal-badge">
                        <div
                          className={`details-modal-badge-dot ${label === "Gaming" ? "green" : label === "Productivity" ? "yellow" : "blue"}`}
                        />
                        <span className="details-modal-badge-label">
                          {label}
                        </span>
                      </div>
                    ))}
                ...
                <div className="details-modal-section">
                  ...
                  >
                    <div style={{ display: "flex", gap: 3 }}>
                      {[1, 2, 3, 4, 5].map((star) => (
                        <StarIcon
                          key={star}
                          filled={
                            star <= Math.round(selectedItem.ratingAvg || 0)
                          }
                        />
                      ))}
                    </div>
                    ...
                    >
                      {(selectedItem.ratingAvg || 0).toFixed(1)}/5
                    </span>
                  </div>
                </div>
                <div
      ...
      {showLogoutModal && (
        <div className="modal-overlay">
          <div className="modal-box">
            ...
            <h6 style={{ fontWeight: 700, marginBottom: 10 }}>
              You are Leaving
            </h6>
            <p style={{ color: "#888", fontSize: 14, marginBottom: 28 }}>
              Are you sure you want to logout from TechWise?
            </p>
      ...
      {showDeleteModal && (
        <div className="modal-overlay">
          <div className="modal-box">
            ...
            <h6 style={{ fontWeight: 600, marginBottom: 10, color: "#6b7280" }}>
              This Cannot Be Undone
            </h6>
            <p style={{ color: "#888", fontSize: 14, marginBottom: 28 }}>
              Are you sure you want to permanently delete your TechWise account?
            </p>
            <div className="modal-actions">
              <button

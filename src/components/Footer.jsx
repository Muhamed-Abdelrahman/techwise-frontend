        ...
        <div className="ft-grid">
          ...
          <div>
            ...
            <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.6)", lineHeight: "1.7", margin: 0 }}>
              Empowering users to optimize<br />their PCs through AI-powered<br />insights and recommendations.
            </p>
          </div>

          {/* Quick Links 1 */}
          <div>
            <h4 style={{ fontSize: "1rem", fontWeight: "700", color: "#fff", margin: "0 0 20px 0" }}>Quick Links</h4>
            {[
              { label: "Home", page: "home" },
              { label: "Device Recommendation", page: "new-device" },
              { label: "Device Evaluation", page: "used-device" },
              { label: "Performance Analysis", page: "performance" },
            ].map((link, i) => (
              <div key={i} style={{ marginBottom: "12px" }}>
                <a onClick={(e) => { e.preventDefault(); setCurrentPage(link.page); }} href="#" style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.6)", textDecoration: "none", cursor: "pointer" }}>{link.label}</a>
              </div>
            ))}
          </div>
          ...
          <div>
            ...
            {[
              ...
              { label: "Device Upgrade", page: "upgrade" },
          ...
          {/* Support */}
          <div>
            <h4 style={{ fontSize: "1rem", fontWeight: "700", color: "#fff", margin: "0 0 20px 0" }}>Support</h4>
            {[
          ...
          {/* Contact Info */}
          <div>
            <h4 style={{ fontSize: "1rem", fontWeight: "700", color: "#fff", margin: "0 0 20px 0" }}>Contact Info</h4>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="2">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <path d="M22 7l-10 7L2 7" />
              </svg>
              <span style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.6)" }}>support@TechWise.com</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "24px" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="2">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
              </svg>
              <span style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.6)" }}>+1 (555) 123-4567</span>
            </div>
